...
async def test_pdf_to_text_workflow(monkeypatch, sample_pdf_path):
    ...
    # summarize_papergLLMí(YãËí‚√Ø
    mock_generate_text = MagicMock(return_value="This is a summarized version of the test paper.")
